...
from sage.matrix.constructor import ZZ
from sage.modules.free_module_element import vector
from sage.rings.infinity import infinity
from sage.rings.number_field.number_field import QuadraticField
from sage.all import latex, Integer, Matrix, matrix, RR
from sage.misc.cachefunc import cached_method
from sage.rings.number_field.number_field_ideal import NumberFieldFractionalIdeal
from sage.modular.cusps_nf import list_of_representatives
from sage.arith.misc import divisors
from sage.modular.cusps_nf import list_of_representatives, units_mod_ideal, NFCusps_ideal_reps_for_levelN
...
from extended_hilbert_modgroup.cusp_nf_wrt_lattice_ideal import gens_reduced_wrt_lattice_ideal
...
def ExtendedHilbertModularGroup(number_field, lattice_ideal=None, level_ideal=None, tp_unit=True):
    r"""
    ...
    - ``tp_unit `` (bool)  - ``True`` if you want the determinant in U_K^+ and ``False`` if 1.
    ...
    return ExtendedHilbertModularGroup_class(number_field, lattice_ideal=lattice_ideal, level_ideal=level_ideal,
                                             tp_unit=tp_unit, sage_name=name, latex_string=ltx)
...
class ExtendedHilbertModularGroup_class(LinearMatrixGroup_generic):
    ...
    def __init__(self, number_field, lattice_ideal, level_ideal, tp_unit, sage_name, latex_string):
        r"""
