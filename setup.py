...
ext_modules = [
    Extension(
        ...
        sources=['src/hilbert_modgroup/hilbert_modular_group_element.pyx'],
    ...
    Extension(
        ...
        sources=['src/hilbert_modgroup/upper_half_plane.pyx'],
        extra_compile_args=extra_compile_args,
        include_dirs=INCLUDE_DIRS,
        library_dirs=LIBRARY_DIRS
    ),
    Extension(
        ...
        sources=['src/hilbert_modgroup/pullback_cython.pyx'],
        language='c++',
    ...
    Extension(
        ...
        sources=['src/extended_hilbert_modgroup/extended_hilbert_modular_group_element.pyx'],
        extra_compile_args=extra_compile_args,
        include_dirs=INCLUDE_DIRS,
        library_dirs=LIBRARY_DIRS
    ),
    Extension(
        ...
        sources=['src/extended_hilbert_modgroup/extended_pullback_cython.pyx'],
        language='c++',
        extra_compile_args=extra_compile_args + ['-std=c++11'],
        include_dirs=INCLUDE_DIRS,
        library_dirs=LIBRARY_DIRS
